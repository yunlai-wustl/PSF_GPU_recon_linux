...
void record_decay_map(std::vector<pos32>& l, int* map, int image_samp_x, int image_samp_y, int image_samp_z, int image_size_x, int image_size_y, int image_size_z, int center);
